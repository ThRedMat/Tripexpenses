...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      if ($stmt->execute()) {
            ...
            header("Location: trip_details_finish.php?id=" . $trip_id . "&msg=added");
            exit();
      } else {
      ...
      if (isset($_GET['trip_id'])) {
            ...
            $sql_trip = "SELECT start_date, end_date FROM trips WHERE id = ?";
...
?>
            ...
            <head>
                  ...
                  <link rel="stylesheet" type="text/css" href="css/add_expense_finish.css">
            </head>

            <body>
                  <div class="container">
                        <h1>Ajouter des Dépenses pour le Voyage</h1>
                        <form action="add_expense_finish.php" method="post">
                        ...
                        <a href="trip_details_finish.php?id=<?php echo htmlspecialchars($trip_id); ?>" class="btn-retour">Annuler</a>
                  </div>
            </body>
